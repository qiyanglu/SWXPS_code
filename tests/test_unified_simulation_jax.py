...
simulation_jax = pytest.importorskip("swanx.simulation_jax", exc_type=ImportError)

from swanx.stack import LayerSlicingPolicy, SimulationStack, StackLayer, fixed_layer_grid_plan
