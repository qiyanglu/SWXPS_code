...
def test_load_optical_constants_parses_header_and_rows():
    table = load_optical_constants(Path("data/OPC") / "LaNiO3.dat")
...
def test_constants_from_file_returns_exact_tabulated_values():
    delta, beta = constants_from_file(Path("data/OPC") / "LaNiO3.dat", energy_ev=5000.00049)
